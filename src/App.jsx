...
const App = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-white mb-2 text-center">🦀 Crab Champions Build Advisor</h1>
        <p className="text-blue-200 text-center mb-8">武器を選んで最適なアップグレードの提案を受けよう！</p>
        ...
        {!selectedWeapon ? (
          ...
          <div className="space-y-6">
            <Card className="bg-white/10 backdrop-blur-lg border-white/20">
              <CardHeader>
                <CardTitle className="text-white flex justify-between items-center">
                  <span>選択中: {selectedWeapon.name} (Tier {selectedWeapon.tier})</span>
                  <Button 
